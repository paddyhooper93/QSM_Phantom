...
USP_3T              = DataFSR.USP(:,1)./2.893;
USP_7T              = DataFSR.USP(:,2)./7;
...
Bias.USP.Beta0_3T         = USP_3T_FITLM.Coefficients{1,1};
Bias.USP.Beta0_3T_CIs     = USP_3T_FITLM.Coefficients{1,2}*tinv(0.025,N-2)*-1;
Bias.USP.Slope_3T         = USP_3T_FITLM.Coefficients{2,1};
...
Bias.FER.Beta0_3T         = FER_3T_FITLM.Coefficients{1,1};
Bias.FER.Beta0_3T_CIs     = FER_3T_FITLM.Coefficients{1,2}*tinv(0.025,N-2)*-1;
Bias.FER.Slope_3T         = FER_3T_FITLM.Coefficients{2,1};
...
c_CHL                = (0.1:0.1:0.5)./110.98.*1000; % mol/L
N                    = length(c_CHL);
CHL_3T_FITLM         = fitlm(c_CHL,CHL_3T);
Bias.CHL.Beta0_3T         = CHL_3T_FITLM.Coefficients{1,1};
Bias.CHL.Beta0_3T_CIs     = CHL_3T_FITLM.Coefficients{1,2}*tinv(0.025,N-2);
Bias.CHL.Slope_3T         = CHL_3T_FITLM.Coefficients{2,1};
...
% Bias.CRB.Beta0_3T         = CRB_3T_FITLM.Coefficients{1,1};
% Bias.CRB.Beta0_3T_CIs     = CRB_3T_FITLM.Coefficients{1,2}*tinv(0.025,N-2);
% Bias.CRB.Slope_3T         = CRB_3T_FITLM.Coefficients{2,1};
